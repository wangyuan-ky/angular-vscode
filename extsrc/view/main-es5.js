...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_require__.d(__webpack_exports__, "VsCodeService", function () {
    ...
    var VsCodeService = /*#__PURE__*/function () {
      function VsCodeService(eventManager) {
        var _this = this;

        _classCallCheck(this, VsCodeService);

        this.eventManager = eventManager;
        this.messageSubject = new rxjs__WEBPACK_IMPORTED_MODULE_3__["Subject"]();
        this.api = acquireVsCodeApi();
        this.eventManager.addGlobalEventListener('window', 'message', function (msg) {
          _this.messageSubject.next(msg.data);
        });
      }

      _createClass(VsCodeService, [{
        key: "getState",
    ...
    VsCodeService.ctorParameters = function () {
      return [{
        type: _angular_platform_browser__WEBPACK_IMPORTED_MODULE_2__["EventManager"]
      }];
    };

    VsCodeService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])()], VsCodeService);

    var AppComponent = /*#__PURE__*/function () {
      function AppComponent(vscode) {
      ...
      _createClass(AppComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.messageSubscription = this.vscode.message$.subscribe(function (msg) {
            _this2.title = JSON.stringify(msg);
          });
        }
      }, {
        key: "ngOnDestroy",
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! /Users/wangyuan/Desktop/angularview/extview/src/main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
